...
#: Rows a day takes. A blank between two of them, which the template puts
#: there rather than the day carrying it: charged to every day it would be
#: wasted at the foot of the frame, and it is worth a fifth day.
